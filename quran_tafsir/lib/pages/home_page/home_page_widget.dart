        ...
        setState(() {
          _model.audioPaths = getJsonField(
            ...
            r'''$.audio[:].path''',
              ...
              .toList()
              .cast<String>();
          _model.verseAudio = _model.audioPaths[(String recitorName) {
            return ["حفص", "ورش", "خلف عن حمزة"].indexOf(recitorName);
                        ...
                        setState(() {
                          _model.audioPaths = getJsonField(
                            ...
                            r'''$.audio[:].path''',
                              ...
                              .cast<String>();
                          _model.verseAudio =
                              _model.audioPaths[(String recitorName) {
                            return ["حفص", "ورش", "خلف عن حمزة"]
                                .indexOf(recitorName);
                          }(_model.recitationSelectorValue!)];
                        });
                  ...
                  children: [
                    FlutterFlowDropDown<String>(
                      controller: _model.recitationSelectorValueController ??=
                        ...
                        _model.recitationSelectorValue ??= 'حفص',
                      ),
