...
class HomePageModel extends FlutterFlowModel {
  ...
  String verseAudio =
      'https://raw.githubusercontent.com/mohammedterryjack/quran-api/main/audio/hafs/1:1.mp3';

  List<String> audioPaths = [];
  void addToAudioPaths(String item) => audioPaths.add(item);
  void removeFromAudioPaths(String item) => audioPaths.remove(item);
  void removeAtIndexFromAudioPaths(int index) => audioPaths.removeAt(index);
  void updateAudioPathsAtIndex(int index, Function(String) updateFn) =>
      audioPaths[index] = updateFn(audioPaths[index]);

  List<String> commentatorNames = [];
  void addToCommentatorNames(String item) => commentatorNames.add(item);
  void removeFromCommentatorNames(String item) => commentatorNames.remove(item);
  void removeAtIndexFromCommentatorNames(int index) =>
      commentatorNames.removeAt(index);
  void updateCommentatorNamesAtIndex(int index, Function(String) updateFn) =>
      commentatorNames[index] = updateFn(commentatorNames[index]);

  List<String> allCommentaries = [];
  void addToAllCommentaries(String item) => allCommentaries.add(item);
  void removeFromAllCommentaries(String item) => allCommentaries.remove(item);
  void removeAtIndexFromAllCommentaries(int index) =>
      allCommentaries.removeAt(index);
  void updateAllCommentariesAtIndex(int index, Function(String) updateFn) =>
      allCommentaries[index] = updateFn(allCommentaries[index]);
  ...
  // State field(s) for RecitationSelector widget.
  String? recitationSelectorValue;
  FormFieldController<String>? recitationSelectorValueController;
  ...
  // Stores action output result for [Backend Call - API (getQuran)] action in IconButton widget.
  ApiCallResponse? apiResultz75;
  // Stores action output result for [Backend Call - API (getQuran)] action in Text widget.
  ApiCallResponse? apiResulto4c1;
  // Stores action output result for [Backend Call - API (getQuran)] action in Chart widget.
  ApiCallResponse? apiResulto4c2;
